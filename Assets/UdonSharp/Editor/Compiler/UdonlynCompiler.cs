...
namespace UdonSharp.Compiler
{
    ...
    public class UdonlynCompiler
    {
        ...
        public static void Compile(UdonSharpCompileOptions options = null)
        {
            ...
            Compile(compilationContext, rootProgramLookup, allSourcePaths, defines);
        }
        ...
        {
            // TODO: Set isEditorBuild
            string[] scriptingDefines = UdonSharpUtils.GetProjectDefines(false);
            ...
            ModuleBinding[] syntaxTrees = compilationContext.LoadSyntaxTreesAndCreateModules(programSource, sourcePath, scriptingDefines);
            ...
            foreach (ModuleBinding module in rootTrees)
            {
